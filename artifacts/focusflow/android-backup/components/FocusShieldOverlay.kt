 ...
 * - "Cancel" text button
 */
class FocusShieldDialogFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(
            ...
            // Note: callbacks can't be passed via Bundle, use static reference
            onRequestAllowanceCallback = onRequestAllowance
            onAddToAllowlistCallback = onAddToAllowlist
            return fragment
        }
    }
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_focus_shield, container, false)

        val iconView = view.findViewById<ImageView>(R.id.shield_icon)
        val titleView = view.findViewById<TextView>(R.id.shield_title)
        val messageView = view.findViewById<TextView>(R.id.shield_message)
        ...
        requestBtn.setOnClickListener {
            onRequestAllowanceCallback?.invoke(pkg)
            dismiss()
        }

        allowlistBtn.setOnClickListener {
            onAddToAllowlistCallback?.invoke(pkg)
            dismiss()
        }
