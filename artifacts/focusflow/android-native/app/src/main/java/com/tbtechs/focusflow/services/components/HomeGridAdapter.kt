...
class HomeGridAdapter(
    ...
    class AppViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val badgeView: com.google.android.material.badge.BadgeDrawable? = null
    ...
    override fun onBindViewHolder(holder: AppViewHolder, position: Int) {
        ...
        if (isBlocked) {
            ...
            badge.apply {
                ...
                // Custom focus shield icon - we'll use a dot for now
                setCustomBadgeContent(holder.iconFrame)
            }
            ...
            // Note: BadgeDrawable doesn't have a simple clear, so we rely on visibility
        }
        ...
        holder.allowanceIndicator.apply {
            ...
            progress = 0f
            visibility = VISIBLE // Show for all apps, update progress based on allowance
        }
